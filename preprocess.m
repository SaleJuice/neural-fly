...
data_no = importdata("no.mat"); data_1070 = importdata("1070.mat");
data_10 = get(data_1070,"10wind");
data_20 = get(data_1070,"20wind");
data_30 = get(data_1070,"30wind");
data_35 = get(data_1070,"35wind");
data_40 = get(data_1070,"40wind");
data_50 = get(data_1070,"50wind");
data_70 = get(data_1070,"70wind");
...
writematrix(all_str, "rflysim_figure8_baseline_70wind.csv")
